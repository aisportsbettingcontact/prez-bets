...
// DATABASE_URL is injected by the sandbox environment
const dbUrl = process.env.DATABASE_URL;
if (!dbUrl) {
  console.error('[ERROR] DATABASE_URL not in environment');
  process.exit(1);
}

console.log('[INFO] DB URL prefix:', dbUrl.substring(0, 30) + '...');
