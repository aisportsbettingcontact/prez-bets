...
console.log("\n\n" + "═".repeat(80));
console.log("TEST 2: Full NCAAB HTML (/home/ubuntu/Downloads/ncaab_all_markets.html)");
console.log("═".repeat(80));
...
console.log("\n\n" + "═".repeat(80));
console.log("TEST 3: Full NBA HTML (/home/ubuntu/Downloads/nba_all_markets.html)");
console.log("═".repeat(80));
...
console.log("\n\n" + "═".repeat(80));
console.log("TEST 4: Full NHL HTML (/home/ubuntu/Downloads/nhl_all_markets.html)");
console.log("═".repeat(80));
