...
print("  [INPUT]  away_pitcher_nrfi=0.5412 (Irvin) | home_pitcher_nrfi=0.6111 (Keller)")
...
print("  [INPUT]  away_pitcher_nrfi=None | home_pitcher_nrfi=None")
...
print(f"\n{'='*60}")
if errors == 0:
    print("\033[92m[ALL TESTS PASSED]\033[0m  0 errors")
else:
