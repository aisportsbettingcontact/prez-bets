...
export const games = mysqlTable("games", {
  ...
  /** Speed up games.list queries filtered by sport */
  idxSport: index("games_sport_idx").on(t.sport),
  /** Speed up games.list queries filtered by sport + date */
  idxSportDate: index("games_sport_date_idx").on(t.sport, t.gameDate),
}));
